...
public abstract class BaseRefreshListFragmentPresenter<V extends IBaseRefreshListView, M extends IBaseRefreshListModel, S extends BaseQuickAdapter>
        extends BaseCoreFragmentPresenter<V, M> implements RefreshLayout.RefreshListener {
